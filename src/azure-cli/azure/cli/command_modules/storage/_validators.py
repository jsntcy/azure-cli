...
def _query_account_key(cli_ctx, account_name):
    ...
    if t_storage_account_keys:
        return scf.storage_accounts.list_keys(rg, account_name, logging_enable=False, expand=None).key1
    # of type: models.storage_account_list_keys_result#StorageAccountListKeysResult
    return scf.storage_accounts.list_keys(rg, account_name, logging_enable=False, expand=None).keys[0].value  # pylint: disable=no-member
